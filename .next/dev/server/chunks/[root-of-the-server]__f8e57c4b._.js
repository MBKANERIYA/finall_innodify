...
"[project]/src/app/api/blogs/[slug]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const blog = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Blog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            slug
        });
        if (!blog) {
...
async function PUT(request, { params }) {
    try {
        ...
        if (body.title && body.title !== blog.title) {
            body.slug = body.title.toLowerCase().replace(/[^\w\s-]/g, '').replace(/\s+/g, '-');
        }
        const updatedBlog = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Blog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            slug
        }, body, {
            new: true,
            runValidators: true
...
async function DELETE(request, { params }) {
    try {
        const { slug } = await params;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const blog = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Blog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndDelete({
            slug
        });
        if (!blog) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f8e57c4b._.js.map